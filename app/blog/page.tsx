...
const blogPosts = [
  {
    id: 'billan-2025-guide',
    title: 'Billån i 2025: Komplett Guide til Renter og Vilkår',
    excerpt: 'Alt du trenger å vite om billån i 2025. Se de nyeste rentene, endringer i regelverket og beste tips for å få godkjent.',
    date: '2025-01-27',
    readTime: '8 min',
    category: 'Guider',
    featured: true,
    image: '/blog/billan-2025.jpg'
  },
  {
  ...
  {
    id: 'rentetrender-2025',
    title: 'Rentetrender 2025: Hva Kan Du Forvente?',
    excerpt: 'Våre eksperter analyserer renteutviklingen og gir deg prediksjoner for billån i 2025.',
    date: '2025-01-17',
    readTime: '6 min',
    category: 'Marked',
    featured: false,
