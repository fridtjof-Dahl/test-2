          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="inline-flex items-center gap-2 bg-blue-50 rounded-full px-6 py-3 mb-8 border border-blue-100">
                ...
                <span className="text-sm font-medium text-[#004D61]">Ekspertsvar på alle spørsmål</span>
              ...
              <h2 className="text-xl sm:text-2xl font-medium text-gray-600 mb-8">
                Få svar på alle spørsmål om billån
              </h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="space-y-12">
            {faqCategories.map((category, categoryIndex) => (
              <div key={categoryIndex} className="bg-white rounded-2xl p-8 shadow-xl border border-gray-100">
